...
This directory contains the Discarr Discord bot tests.
...
3. **Descriptive Names**: Test method names should name the behavior under test
...
6. **Coverage**: Add tests for named failure paths; coverage percentage alone isn't sufficient
